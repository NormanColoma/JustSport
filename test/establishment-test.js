...
describe('Establishments', function(){
    ...
    before('Setting database in a known state',function(done) {
        umzug.execute({
            migrations: ['20160315113959-create-commentary.js','20160323111436-create-vote','20151106004253-create-establishment','20151022133423-create-user','20151016205501-sport-migration',
   ...
   it('Updating establishment without access token. Should return status 401', function(done){
    ...
    after('Dropping database',function(done) {
        seeder.execute({
            ...
            umzug.down(['20160315113959-create-commentary.js','20160323111436-create-vote','20151106004323-create-establishmentsport','20151106004253-create-establishment','20151016205501-sport-migration',
