...
describe('Votes', function() {
    ...
    before('Setting database in a known state', function (done) {
        umzug.execute({
            migrations: ['20151108193656-create-course.js','20160315113959-create-commentary.js','20160323111436-create-vote','20151106004253-create-establishment',
                '20151016205501-sport-migration', '20151106004323-create-establishmentsport','20151022133423-create-user', '20160315113959-create-commentary'],
            method: 'down'
        }).then(function (migrations) {
            umzug.up(['20151022133423-create-user', '20160311103832-add-img-user', '20151106004253-create-establishment',
                '20151016205501-sport-migration', '20151106004323-create-establishmentsport','20160323111436-create-vote',
                '20160315113959-create-commentary.js','20151108193656-create-course.js']).then(function (migrations) {
                done();
            });
        });
    });
    ...
    after('Dropping database',function(done) {
        seeder.execute({
            ...
            umzug.down(['20151108193656-create-course.js','20160315113959-create-commentary.js','20160323111436-create-vote',
                '20151106004323-create-establishmentsport','20151106004253-create-establishment', '20151016205501-sport-migration','20160311103832-add-img-user',
